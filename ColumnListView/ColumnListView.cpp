...
//**** ColumnListView CLASS DEFINITION
//******************************************************************************************************
ColumnListView::ColumnListView(BRect Frame, BetterScrollView **ContainerView, const char *Name,
...
fDownArrow(BRect(0.0,0.0,10.0,10.0),B_COLOR_8_BIT,CLVDownArrowData,false,false)
{
	...
	CreateContainer(horizontal,vertical,scroll_view_corner,border,ResizingMode,flags);
...
void ColumnListView::CreateContainer(bool horizontal, bool vertical, bool scroll_view_corner, border_style border,
...
void ColumnListView::AssertWindowLocked() const
{
	...
	if(ParentWindow && !ParentWindow->IsLocked())
		_debuggerAssert(__FILE__,__LINE__,"The looper must be locked.");
}
